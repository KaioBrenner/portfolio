...
import { BsLinkedin, BsGithub, BsInstagram, BsTwitch } from "react-icons/bs";
    ...
    <div>
      ...
      <section class="home-hero">
        ...
        <div class="home-hero__socials">
          ...
          <div class="justify-center items-center">
            <a
              href="https://www.instagram.com/kaio_brenner1/"
              target="_blank"
              class="home-hero__social-icon-link text-[24px]"
            >
          ...
          <div class="justify-center items-center">
            <a
              href="https://www.twitch.tv/kbrennerss"
              target="_blank"
              class="home-hero__social-icon-link home-hero__social-icon-link--bd-none  text-[24px]"
            >
              <BsTwitch></BsTwitch>
            </a>
          </div>
          ...
          <div class="projects__content">
            <div class="projects__row">
              ...
              <div class="projects__row-content">
                <h3 class="projects__row-content-title">Hoobank</h3>
                <p class="projects__row-content-desc">
                  Landing Page projetada para um banco e estilizada com o
                  TailwindCSS.
                </p>
                ...
                <a
                  ...
                  href="https://kaiobrenner.github.io/bank-modern-app/"
                  target="_blank"
                >
                  Ver Projeto
                </a>
